...
const speakerList = [
    ...
    {
        image: "assets/img/taj_hussain.png",
        name: "Taj Hussain",
        occupation: "Cybersecurity Specialist",
        title: "Cybersecurity Workshop",
        about: `A cybersecurity professional with more than 8 years of experience, Taj Hussain is a resident of Darwin, Australia and a certified Ethical Hacker. With a passion for tackling new challenges in the Cyber Security industry, Taj is incredibly skilled in the field of operating systems, network security & maintenance, Pen testing, threat analysis & incident response achieve outcomes, and also possesses excellent interpersonal, customer service skills. Currently, Taj is working at a leading Non-Profit organisation as a support worker in the disability sector. When he is not busy coming up with new and innovative solutions for the cybersecurity industry, he also volunteers at Charles Strut University as a mentor to students interested in the same field he is passionate about.  He also acts as the President of the Student Representative Committee, and performs activities for increasing student awareness and employment and training information and resources. He can also be found on platforms such as TryHackMe(mtajh), INE EDx, TCM Academy, Attack IQ and We Hack Purple hosting rooms and courses on cybersecurity.`,
    },
];
